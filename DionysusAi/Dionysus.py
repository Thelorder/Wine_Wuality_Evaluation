...
def prepare_features(df):
    ...
    y = df['quality']  # 🔥 REGRESSION TARGET

    # Drop unavailable sensor
...
def tune_random_forest_regressor(X_train, y_train):
    print("\n🎛️ Tuning Random Forest Regressor...")
...
def main():
    ...
    data_path = r"C:\Users\User\Desktop\Python Code\kaggle_data\winequalityN.csv"
